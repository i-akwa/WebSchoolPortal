<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comingsoon.aspx.cs" Inherits="WebSchoolPortal.App_Resources.Pages.AllGeneral.comingsoon.comingsoon" %>
...
<body class="rain-bg">
    <form id="form1" runat="server">
		...
		<section class="main-menu-container">
			...
			<div class="show_toggle"> <asp:LinkButton ID="LinkButton2" ToolTip="click to go back to dashboard" runat="server" PostBackUrl="~/App_Resources/Pages/School_Administrator/Schooladmindashboard.aspx" ></asp:LinkButton></div>
			<ul class="main-menu">
				<li>
                    <asp:LinkButton ID="LinkButton1"  runat="server" PostBackUrl="~/App_Resources/Pages/School_Administrator/Schooladmindashboard.aspx">Home</asp:LinkButton>
