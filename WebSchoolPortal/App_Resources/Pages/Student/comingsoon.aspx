<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comingsoon.aspx.cs" Inherits="WebSchoolPortal.App_Resources.Pages.Student.comingsoon" %>
...
<body class="rain-bg">
    <form id="form1" runat="server">
		...
		<section class="main-menu-container">
			...
			<div class="show_toggle"> <asp:LinkButton ID="LinkButton2" ToolTip="click to go back to dashboard" runat="server" PostBackUrl="~/App_Resources/Pages/Student/studentdashboard.aspx" ></asp:LinkButton></div>
			<ul class="main-menu">
				<li>
                    <asp:LinkButton ID="LinkButton1"  runat="server" PostBackUrl="~/App_Resources/Pages/Student/studentdashboard.aspx">Home</asp:LinkButton>
		...
		<script src="../AllGeneral/comingsoon/js/vendor/jquery-1.11.1.min.js" type="text/javascript" charset="utf-8"></script>
		<script src="../AllGeneral/comingsoon/js/vendor/classie.js" type="text/javascript" charset="utf-8"></script>
		<script src="../AllGeneral/comingsoon/js/vendor/jquery.easing.1.3.js" type="text/javascript" charset="utf-8"></script>
		<script src="../AllGeneral/comingsoon/js/vendor/jquery.tubular.1.0.js" type="text/javascript" charset="utf-8"></script>
		<script src="../AllGeneral/comingsoon/js/vendor/jquery.cycle.min.js" type="text/javascript" charset="utf-8"></script>
		<script src="../AllGeneral/comingsoon/js/plugins.js" type="text/javascript" charset="utf-8"></script>
		<script src="../AllGeneral/comingsoon/js/main.js" type="text/javascript" charset="utf-8"></script>

		<script src="../AllGeneral/comingsoon/clock/js/svg.min.js" type="text/javascript" charset="utf-8"></script>
		<script src="../AllGeneral/comingsoon/clock/js/svg.easing.min.js" type="text/javascript" charset="utf-8"></script>
		<script src="../AllGeneral/comingsoon/clock/js/svg.clock.min.js" type="text/javascript" charset="utf-8"></script>
		<script src="../AllGeneral/comingsoon/js/vendor/ThreeWebGL.js" type="text/javascript" charset="utf-8"></script>
		<script src="../AllGeneral/comingsoon/js/vendor/ThreeExtras.js" type="text/javascript" charset="utf-8"></script>
		<script src="../AllGeneral/comingsoon/clock/js/jquery.timers.min.js" type="text/javascript" charset="utf-8"></script>
		<script src="../AllGeneral/comingsoon/clock/js/clock.js" type="text/javascript" charset="utf-8"></script>
<script>
